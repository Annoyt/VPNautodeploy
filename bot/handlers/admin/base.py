...
ADMIN_HELP_TEXT = (
    ...
    "🤖 <b>AI / Kimi</b> (в любом топике или PM, admin-only)\n"
    "• <code>/ai &lt;запрос&gt;</code> — спросить kimi (default mode)\n"
    ...
    "  (vpn-ops | server-admin | code-review | incident-response | billing-ops)\n"
    "• <code>/ai_status</code> — статус kimi-bridge + сессия\n"
    "• <code>/ai_reset</code> — сбросить сессию\n"
    "• 📷 фото в #Kimi — kimi прочитает картинку\n\n"
